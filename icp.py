...
def icp(reference_points, points, max_iterations=100, distance_threshold=0.3, convergence_translation_threshold=1e-3,
    ...
    :Added: return of total transform parameters, x, y, theta which is the sum of all the transformation history
    
    """

    transformation_history = []
    converged_translation_x, converged_translation_y, converged_rot_angle = 0,0,0,
    ...
    for iter_num in range(max_iterations):
        ...
        if closest_rot_angle is not None:
            converged_translation_x = converged_translation_x + closest_translation_x
            converged_translation_y = converged_translation_y + closest_translation_y
            converged_rot_angle = converged_rot_angle + closest_rot_angle
    ...
    measurement = np.array([converged_translation_x, converged_translation_y, converged_rot_angle])
    return transformation_history, points, measurement
